...
#define AME_FILE_ALREADY_EXISTS_ERROR -5
#define AME_FULL_MEMORY_ERROR -6
#define AME_INVALID_BLOCK_NUMBER_ERROR -7
#define AME_GETBLOCK_ERROR -8
#define ERROR -9
#define AM_ALLOC_ERROR -10
#define AM_UNPIN_ERROR -11
#define AME_GETBLOCK_COUNTER_ERROR -12
#define AME_TYPE_ERROR -13
#define AME_OPEN_FILE_ERROR -14
#define AME_OPEN_FILE_SCAN_ERROR -15
#define AME_FAIL_DESTROY_INDEX_ERROR -16
#define AME_CLOSE_FILE_ERROR -17
#define AME_UNITIALIZED_FILE_ERROR -18
#define AME_CLOSE_FILE_SCAN_ERROR -19
#define EQUAL 1
#define NOT_EQUAL 2
#define LESS_THAN 3
